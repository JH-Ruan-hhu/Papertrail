...
contextBridge.exposeInMainWorld('paperTrail', {
  ...
  getCompany: id => ipcRenderer.invoke('companies:get',id),
  listCompanies: () => ipcRenderer.invoke('companies:list'),
  configureCompany: (id,input) => ipcRenderer.invoke('companies:configure',id,input),
  refreshCompanyLogo: id => ipcRenderer.invoke('companies:refresh',id),
  setCompanyLogo: id => ipcRenderer.invoke('companies:manual',id),
  onCompanyChanged: on('companies:changed'),
