...
app.whenReady().then(async()=>{try{
 ...
 check(CSS.supports('appearance','base-select'),'rounded native picker supported');return {roundedPicker:true,collapsedCards:true,records:wb.workspace.jobApplications.length,stageDeadlines:true,relativeDeadline:true,closures:true,resumeRemoved:true,companyShared:true,capture:true};})()`);
