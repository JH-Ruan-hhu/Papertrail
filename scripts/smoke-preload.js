...
let smokeWorkspace = {
  ...
  jobApplications: [
    ...
    { id: 'job-submitted-1', company: '清研检测', role: 'LC-MS/MS 分析工程师', lifecycleStatus: 'active', status: 'active', companyType: '检测机构', city: '杭州', location: '杭州', deadline: new Date(now + 30 * 86_400_000).toISOString(), priority: 'medium', sourceUrl: null, contact: '招聘平台', appliedAt: todayAt(9, 0), nextFollowUpAt: null, nextActionAt: null, notes: '等待筛选反馈', createdAt: todayAt(8, 15), updatedAt: todayAt(9, 0), workflow: smokeWorkflow('submitted-1', ['投递', '网测', '一面', '二面', '终面', 'Offer'], 0, { 0: todayAt(9, 0) }), revision: 1 },
    ...
    { id: 'job-offer-1', company: '水安全中心', role: '技术研究员', lifecycleStatus: 'closed', status: 'closed', companyType: '事业单位', city: '无锡', location: '无锡', deadline: null, priority: 'medium', annualSalaryWan: 41.1, sourceUrl: null, contact: '邮件', appliedAt: todayAt(9, 20), nextFollowUpAt: null, nextActionAt: null, notes: '评估入职时间', createdAt: todayAt(8, 25), updatedAt: todayAt(9, 20), workflow: smokeWorkflow('offer-1', ['投递', '网测', '一面', '二面', '终面', 'Offer'], 5, { 0: todayAt(9, 20), 1: todayAt(10, 20), 2: todayAt(11, 20), 3: todayAt(13, 20), 4: todayAt(15, 20), 5: todayAt(17, 20) }), revision: 1 }
  ]
};
